...
<head>
  ...
  <title>SASS | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-invert-colors"></i> CSS</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="css-sass.html">Sass</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">SASS</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">CSS</a>
                  </li>
                  <li class="active">SASS</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div id="sass-variables" class="section">
            <h4 class="header">Variables</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>When using Sass, you can change the color scheme of your site extremely quickly. Below is a very small sample of what you can change through sass in <code class=" language-scss">_variables.scss</code>.</p>
              </div>
...
/*** More variables not shown here.. ***/
          ...
          <!--Media Queries-->
          <div class="divider"></div>
          <div id="media-queries" class="section">
            <h4 class="header">Media Queries</h4>
            <p class="caption">We have 3 media queries for the 3 standard screen sizes you can use in your custom Sass files. This also includes media query variables that will define the range.</p>
            <div class="row">
              <div class="col s12 m4 l3">
...
<pre><code class="language-scss">
  ...
  @media #{$large-and-up} {
    // styles for large screens and up
          ...
          <!--Prefixer-->
          <div class="divider"></div>
          <div id="sass-prefixer" class="section">
            <h4 class="header">Prefixer</h4>
            <p class="caption">One major goal of this framework is to be as adaptable as possible which includes cross browser compatibility. We have adapted a prefixer script to Sass which will automatically add all browser prefixes for certain CSS properties.</p>
            <div class="row">
              <div class="col s12 m4 l3">
                  <p>For Example: Using this Sass mixin</p>
                  <pre><code class="language-scss">  @include transition(.3s);</code></pre>
              </div>
              <div class="col s12 m8 l9">
  ...
  transition: 0.3s;
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                  <p>Here is the full list of mixins</p>
              </div>
              <div class="col s12 m8 l9">
                  <pre><code class="language-scss">
 animation($args)
