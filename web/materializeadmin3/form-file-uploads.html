                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-editor-insert-comment"></i> Forms <span class="new badge"></span></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="form-file-uploads.html">File Uploads</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">File Upload</h5>
        ...
        <div class="container">
          ...
          <div id="file-upload" class="section">
            ...
            <div class="row section">
              ...
              <div class="col s12 m8 l9">
                  <input type="file" id="input-file-events" class="dropify-event" data-default-file="images/gallary/1.jpg" />
              </div>
            </div>
