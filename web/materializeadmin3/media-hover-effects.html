...
<head>
  ...
  <title>Gallary Page | Materialize - Material Design Admin Template</title>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-image"></i> Medias</a>
                        <div class="collapsible-body">
                            <ul>                                        
                                <li><a href="media-gallary-page.html">Gallery Page</a>
                                </li>
                                <li class="active"><a href="media-hover-effects.html">Image Hover Effects</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Gallary Page</h5>
                <ol class="breadcrumbs">
                    <li><a href="index.html">Dashboard</a></li>
                    <li><a href="#">Pages</a></li>
                    <li class="active">Gallary Page</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Masonry  with Magnific Popup is a responsive lightbox & dialog script with focus on performance and providing best experience for user with any device</p>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-lily">
                    <img src="images/gallary/1.jpg" alt="img1"/>
                    <figcaption>
                      <div>
                        <h2>Nice <span>Lily</span></h2>
                        <p>Lily likes to play with crayons and pencils</p>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-sadie">
                    <img src="images/gallary/2.jpg" alt="img02"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-sadie">
                    <img src="images/gallary/14.jpg" alt="img14"/>
                    <figcaption>
                      <h2>Holy <span>Sadie</span></h2>
                      <p>Sadie never took her eyes off me. <br>She had a dark soul.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-honey">
                    <img src="images/gallary/4.jpg" alt="img04"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-honey">
                    <img src="images/gallary/5.jpg" alt="img05"/>
                    <figcaption>
                      <h2>Dreamy <span>Honey</span> <i>Now</i></h2>
                      <a href="#">View more</a>
                    </figcaption>     
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-layla">
                    <img src="images/gallary/6.jpg" alt="img06"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-layla">
                    <img src="images/gallary/3.jpg" alt="img03"/>
                    <figcaption>
                      <h2>Crazy <span>Layla</span></h2>
                      <p>When Layla appears, she brings an eternal summer along.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-zoe">
                    <img src="images/gallary/25.jpg" alt="img25"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-zoe">
                    <img src="images/gallary/26.jpg" alt="img26"/>
                    <figcaption>
                      <h2>Creative <span>Zoe</span></h2>
                      <p class="icon-links">
                        <a href="#"><span class="icon-heart"></span></a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-oscar">
                    <img src="images/gallary/9.jpg" alt="img09"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-oscar">
                    <img src="images/gallary/10.jpg" alt="img10"/>
                    <figcaption>
                      <h2>Warm <span>Oscar</span></h2>
                      <p>Oscar is a decent man. He used to clean porches with pleasure.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-marley">
                    <img src="images/gallary/11.jpg" alt="img11"/>
                    <figcaption>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-ruby">
                    <img src="images/gallary/13.jpg" alt="img13"/>
                    <figcaption>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-roxy">
                    <img src="images/gallary/15.jpg" alt="img15"/>
                    <figcaption>
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-roxy">
                    <img src="images/gallary/1.jpg" alt="img01"/>
                    <figcaption>
                      <h2>Charming <span>Roxy</span></h2>
                      <p>Roxy was my best friend. She'd cross any border for me.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-bubba">
                    <img src="images/gallary/16.jpg" alt="img16"/>
                    <figcaption>
                      <h2>Fresh <span>Bubba</span></h2>
                      <p>Bubba likes to appear out of thin air.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-romeo">
                    <img src="images/gallary/18.jpg" alt="img18"/>
                    <figcaption>
                      <h2>Wild <span>Romeo</span></h2>
                      <p>Romeo never knows what he wants. He seemed to be very cross about something.</p>
                      <a href="#">View more</a>
              ...
              <div class="row">   
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-dexter">
                    <img src="images/gallary/19.jpg" alt="img19"/>
                    <figcaption>
              ...
              <div class="row">
                ...
                <div class="col s12 m6 grid">
                  <figure class="effect-sarah">
                    <img src="images/gallary/20.jpg" alt="img20"/>
                    <figcaption>
                      <h2>Free <span>Sarah</span></h2>
                      <p>Sarah likes to watch clouds. She's quite depressed.</p>
                      <a href="#">View more</a>
