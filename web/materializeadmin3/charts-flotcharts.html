    ...
    <div class="wrapper">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-chart"></i> Charts</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="charts-flotcharts.html">Flot Charts</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id ="flotchart" class="container">
          <div class="section">
            <p class="caption"><a href="http://www.flotcharts.org/" target="_blank">Flot</a> is a pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive looks and interactive features.</p>
