                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-invert-colors"></i> CSS</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="css-media.html">Media</a>
                                </li>
        ...
        <div class="container">
          <p class="caption">Media can be styled in different ways using Materialize.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col s12 m8 l9">
                      <div class="card-panel">
                        <img class="responsive-img" src="images/style_typography_roboto.png" alt="style typography">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col s12 m8 l9">
                      <div class="card-panel grey lighten-5 z-depth-1">
                        <div class="row valign-wrapper">
                          <div class="col s4 m2">
                            <img src="images/avatar.jpg" alt="" class="circle responsive-img valign">
                          </div>
                ...
                <div id="responsive-videos" class="section">
                  ...
                  <div class="row">
                    <div class="col s12 m4 l3">                      
                      <p>If your video does not have video controls, add the <code class=" language-markup">no-controls</code> class to the video container.
                      </p>
                    </div>
                    <div class="col s12 m8 l9">
                      <div class="card-panel">
                        <div class="video-container no-controls">
                          <iframe width="640" height="360" src="https://www.youtube.com/embed/Skpu5HaVkOc" frameborder="0" allowfullscreen></iframe>
                        </div>
                      </div>
                    </div>
                  </div>
