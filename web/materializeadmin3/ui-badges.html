...
<head>
  ...
  <title>Badges | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-badges.html">Badges</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Badges</h5>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Badges can notify you that there are new or unread messages or notifications. Add the new class to the badge to give it the background.</p>
          <div class="divider"></div>
          <!--Badge-->
          <div id="badge-example">
            <h4 class="header">Badges in Collections</h4>
            <div class="row">
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p>Badges in Dropdown</p>
              </div>
              <div class="col s12 m8 l9">
                <ul id="dropdown2" class="dropdown-content">
                  <li><a href="#!">one<span class="badge">1</span></a>
                  </li>
                  <li><a href="#!">two<span class="new badge">1</span></a>
                  </li>
                  <li><a href="#!">three</a>
                  </li>
                </ul>
              ...
              <div class="col s12 m8 l9">
                <ul class="collection">
                  <li class="collection-item avatar">
                    ...
                    <p>First Line
                      <br> Second Line <span class="badge">1</span>
                    </p>
                  ...
                  <li class="collection-item avatar">
                    ...
                    <span class="title">Title</span>
                    <p>First Line
                      <br> Second Line <span class="new badge">4</span>
                    </p>
                    <a href="#!" class="secondary-content"><i class="mdi-action-grade"></i></a>
                  </li>
                  <li class="collection-item avatar">
                    ...
                    <span class="title">Title</span>
                    <p>First Line
                      <br> Second Line <span class="new badge">2</span>
                    </p>
                    <a href="#!" class="secondary-content"><i class="mdi-action-grade"></i></a>
                  </li>
                  <li class="collection-item avatar">
                    ...
                    <span class="title">Title</span>
                    <p>First Line
                      <br> Second Line<span class="badge">4</span>
                    </p>
                    <a href="#!" class="secondary-content"><i class="mdi-action-grade"></i></a>
                  </li>
                </ul>
