  ...
  <div id="main">
    ...
    <div class="wrapper">
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-chart"></i> Charts</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="charts-sparklines.html">Sparkline Charts</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            <p class="caption"><a href="http://omnipotent.net/jquery.sparkline/#s-docs" target="_blank">Sparkline</a> - This jQuery plugin generates sparklines (small inline charts) directly in the browser using data supplied either inline in the HTML, or via javascript.</p>
