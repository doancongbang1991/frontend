...
<head>
  ...
  <title>Preloader | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-preloader.html">Preloader</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Preloader</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">UI Elements</a>
                  </li>
                  <li class="active">Preloader</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <!--Linear-->
          <div id="linear-preloader" class="section">
            <h4 class="header">Linear</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="caption">Simple Linear</p>
              </div>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="caption">Indeterminate Linear</p>
              </div>
              <div class="col s12 m8 l9">
                <div class="progress">
          ...
          <div class="divider"></div>
          <!--Circular-->
          <div id="circular-preloader">
            <h4 class="header">Circular</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="caption">SimpleCircular</p>
              </div>
              <div class="col s12 m8 l9">
                <div class="row">
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="caption">Circular Flashing Colors</p>
              </div>
              <div class="col s12 m8 l9">
                <div class="row">
                  <div class="col s12 m4 center">
