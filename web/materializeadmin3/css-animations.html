...
<head>
  ...
  <title>Animations | Materialize - Material Design Admin Template</title>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Animations</h5>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><a href="https://daneden.github.io/animate.css/" target="_blank">Animate.css</a> Just-add-water CSS animations.</p>
          <div class="divider"></div>
          <!--range-slider-->
          <div id="range-slider" class="section">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Basic Animations</h4>
              ...
              <div class="col s12 m8 l9">
                  ...
                  <div class="row">
                      <div class="col s12 m12 l12">
                          ...
                          <p>Add the class <code>animated</code> to the element you want to animate. You may also want to include the class <code>infinite</code> for an infinite loop.</p>
                          <p>Example:</p>
                          <button type="button" class="btn waves-effect waves-light light-blue accent-3 animated infinite rubberBand">Infinite rubberBand</button>
