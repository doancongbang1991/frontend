...
<head>
  ...
  <title>Pricing Blank | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-action-shopping-cart"></i> eCommers</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="eCommerce-pricing.html">Pricing Table</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Pricing Page</h5>
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Pricing tables design is important to sell your services. For that reason, we have created various pricing tables design with builder to suit your needs.</p>
            ...
            <div class="row">
              ...
              <div class="col s12">
                <br><br>
                <div class="divider"></div>
                <h4 class="header">Pricing tables style 2</h4>                
              </div>              
