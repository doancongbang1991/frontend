                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-toasts.html">Toasts</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Toasts</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">UI Elements</a>
                  </li>
                  <li class="active">Toasts</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Toasts are content that are not original visible on a page but show up with extra information if needed. The transitions should make the appearance of the toast make sense and not jarring to the user.</p>
          ...
          <div id="toasts" class="section">
            ...
            <div class="row">
              ...
              <div class="col s12 m8 l9">
                <p>This theme provides an easy way for you to send unobtrusive alerts to your users through toasts. These toasts are also placed and sized responsively, try it out by clicking the button below on different device sizes.</p>
                <a class="waves-effect waves-light btn light-blue" onclick="Materialize.toast('I am a toast', 4000)">Toast!</a>
              </div>
            </div>

            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Custom HTML</h4>
                <p>You can pass in an HTML String as the first argument as well.</p>
              </div>
              <div class="col s12 m8 l9">
                <p> Take a look at the example below, where we pass in text as well as a flat button. If you call an external function instead of in-line JavaScript, you will not need to escape quotation marks.</p>
                <a class="waves-effect waves-light light-blue btn" onclick="Materialize.toast('<span>Item Deleted</span><a class=&quot;btn-flat yellow-text&quot; href=&quot;#!&quot;>Undo<a>', 5000)">Toast Me!</a>
                <a class="waves-effect waves-light light-blue btn" onclick="Materialize.toast('<span>Item Deleted</span><a class=&quot;btn light-blue &quot; href=&quot;#!&quot;>Undo<a>', 5000)">Toast Again!</a>
              </div>
            </div>
          </div>
          ...
          <div class="divider"></div>
          <!--tosts-callback-->
          <div id="tosts-callback">
            <h4 class="header">Callback</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>You can have the toast callback a function when it has been dismissed</p>
              </div>
              <div class="col s12 m8 l9">
                <a class="btn light-blue" onclick="Materialize.toast('I am a toast', 4000,'',function(){alert('Mickey ! Your toast was dismissed')})">Toast!</a>
              </div>
            </div>
          </div>
          ...
          <div class="divider"></div>
          <!--styling-toasts-->
          <div id="styling-toasts">
            <h4 class="header">Styling ToastsCallback</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>We've added the ability to customize your toasts easily. You can pass in classes as an optional parameter into the toast function. </p>
              </div>
              <div class="col s12 m8 l9">
                <p>We've added a rounded class for you, but you can create your own CSS classes and apply them to toasts. Checkout out our full example below.</p>
                <a class="waves-effect waves-light light-blue btn" onclick="Materialize.toast('I am a toast!', 3000, 'rounded')">Round Toast!</a>
              </div>
            </div>
          </div>
