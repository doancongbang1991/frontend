...
<head>
  ...
  <title>floatThead | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-editor-border-all"></i> Tables</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="table-floatThead.html">floatThead</a>
                                </li>
                            </ul>
                        </div>
                    </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">floatThead</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">Tables</a>
                  </li>
                  <li class="active">floatThead</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><a href="http://mkoryak.github.io/" target="_blank">floatThead</a> is a floating/locked/sticky/fixed table header plugin that requires no special CSS and supports window and overflow scrolling.</p>
          <div class="divider"></div>
          <!--floatThead-->
          <div id="floatThead" class="section">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Window Scrolling</h4>
              </div>
              <div class="col s12 m8 l9">
                  <p>Window scrolling is used when you have a large table that takes up the whole screen.</p>
...
$('table.demo2').floatThead({
  ...
  <footer class="page-footer">
    ...
    <!--floatThead -->
    <script type="text/javascript" src="js/plugins/floatThead/jquery.floatThead.min.js"></script>
    <script type="text/javascript" src="js/plugins/floatThead/jquery.floatThead-slim.min.js"></script>
    <!--plugins.js - Some Specific JS codes for Plugin Settings-->
    <script type="text/javascript" src="js/plugins.min.js"></script>
    <!--custom-script.js - Add your own theme custom JS-->
    <script type="text/javascript" src="js/custom-script.js"></script>
    <!--floatThead custom js-->
