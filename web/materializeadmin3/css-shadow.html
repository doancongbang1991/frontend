...
<head>
  ...
  <title>Shadow | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-invert-colors"></i> CSS</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="css-shadow.html">Shadow</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Shadow</h5>
          ...
          <div class="section">
              ...
              <div class="divider"></div>
                ...
                <div id="shadow-demo" class="section">
                  <h4 class="header">z-depth</h4>
                  <div class="row">
                    <div class="col s12 m4 l3">
                      <p>You can easily apply this shadow effect by adding a <code class=" language-markup">class="z-depth-2"</code> to an HTML tag. Alternatively you can extend any of these shadows with Sass using <code class=" language-scss"><span class="token keyword">@extend</span> .z-depth-2</code>.</p>
                    </div>
