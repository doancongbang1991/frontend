...
<head>
  ...
  <title>Alerts | Materialize - Material Design Admin Template</title>
  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="ui-alerts.html">Alerts</a>
                                </li>
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><a href="ui-alerts.html" target="_blank">Alerts</a> are simple materialize cars that provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.</p>
                    ...
                    <div id="card-alert" class="card cyan lighten-5">
                      <div class="card-content cyan-text">
                        <p class="single-alert">
                          <img src="images/avatar.jpg" alt="avatar" class="alert-circle responsive-img valign profile-image"/>
