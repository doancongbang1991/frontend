...
<head>
  ...
  <title>jsGrid | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-editor-border-all"></i> Tables</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="table-jsgrid.html">jsGrid</a>
                                </li>
          ...
          <div id="jsgrid" class="section">
            <div class="row">
              ...
              <div class="col s12 m8 l9">
                  <p>lightweight client-side data grid control based on jQuery. It supports basic grid operations like inserting, filtering, editing, deleting, paging and sorting. jsGrid is flexible and allows to customize appearance and components.</p>              </div>
            </div>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p>Custom Row Renderer</p>
              </div>
              <div class="col s12 m8 l9">
                  <p>All components of the grid can be easily configured. Heading, filtering, inserting, editing, sorting, paging and row selection could be switched with a single corresponding boolean option.</p>
                  <div id="jsGrid-custom-row"></div>
              </div>
            </div>
