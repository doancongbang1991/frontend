      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Typography</h5>
                ...
                <div class="col s12 m12 l12">
                    <div class="section">
                        <div id="roboto">
                            ...
                            <div class="row">
                                <div class="col s12 m4 l3">
                                    <p>We bundle our framework with the latest iteration of Roboto Google has released. It comes with 5 different font weights you can use: 200, 300, 400, 500, 600.
                                        <br>
                                        <br> Here is an image from Google's Roboto Specimen document displaying the different font weights.</p>
                                </div>
                                <img class="col s12 m8 l9" src="images/style_typography_roboto.png" alt="style typography">
                        ...
                        <div id="blockquote" class="section">
                            <h4 class="header">Blockquotes</h4>
                            <div class="row">
                                <div class="col s12 m4 l3">
                        ...
                        <div id="paragraph" class="section">
                            <div class="row">
                                <div class="col s12 m4 l3">
                                    <h4 class="header">Paragraph</h4>
                                </div>
                                <div class="col s12 m8 l9">
                                    <div class="card-panel">
                                        <p>This is a paragraph. Paragraphs are preset with a font size, line height and spacing to match the overall vertical rhythm. To show what a paragraph looks like this needs a little more content so, did you
                                            know that there are storms occurring on Jupiter that are larger than the Earth? Pretty cool. Wrap strong around type to make it bold!. You can also use em to <em>italicize</em> your words.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
