                            ...
                            <form class="col s12 left-alert">
                              <div class="row">
                                  <div class="input-field col s12">
                                    ...
                                    <label for="first_input1" data-error="Please enter first name.">First Name</label>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="input-field col s12">
                                    <input id="age_input1" type="number" class="validate" placeholder="25">
                                    <label for="age_input1" data-error="Please enter your age.">Age</label>
                                  </div>
                              </div>
                              <div class="row">
                                <div class="input-field col s12">
                                  <input id="email_input1" type="email" class="validate" placeholder="john@domainname.com">
                                  <label for="email_input1" class="" data-error="Please enter valid email." data-success="I Like it!">Email</label>
                                </div>
                              </div>
                              <div class="row">
                                <div class="input-field col s12">
                                  <input id="url_input1" type="url" class="validate"  placeholder="http://geekslabs.com/">
                                  <label for="url_input1" class="" data-error="Please enter valid url.">URL</label>
                                </div>
                              </div>
                              <div class="row">
                                <div class="input-field col s12">
