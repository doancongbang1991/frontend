  ...
  <div id="main">
    ...
    <div class="wrapper">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-chart"></i> Charts</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="charts-morris.html">Morris Charts</a>
                                </li>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            <p class="caption"><a href="http://morrisjs.github.io/morris.js/index.html" target="_blank">Morris.js</a> - Good-looking charts shouldn't be difficult.</p>
