...
<head>
  ...
  <title>Waves | Materialize - Material Design Admin Template</title>
...
<body>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Waves</h5>
        ...
        <div class="container">
          ...
          <!--Applying Waves-->
          <div id="applying-waves" class="section">
            <h4 class="header">Applying Waves</h4>
            <div class="row">
  ...
  &lt;a class="waves-effect waves-light btn-large" href="#">Wave&lt;/a>
          ...
          <div id="customization" class="section scrollspy">
            <h4 class="header">Customization</h4>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Available Colors</h4>
    ...
    &lt;a href="#!" class="btn waves-effect waves-teal">Send&lt;/a>
                ...
                <div class="collection waves-color-demo">
                  <div class="collection-item">Default<a href="#!" class="waves-effect btn secondary-content white black-text">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-light</code><a href="#!" class="waves-effect waves-light btn secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-red</code><a href="#!" class="waves-effect waves-red btn white black-text secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-yellow</code><a href="#!" class="waves-effect waves-yellow btn white black-text secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-orange</code><a href="#!" class="waves-effect waves-orange btn white black-text secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-purple</code><a href="#!" class="waves-effect waves-purple btn white black-text secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-green</code><a href="#!" class="waves-effect waves-green btn white black-text secondary-content">Send</a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-teal</code><a href="#!" class="waves-effect waves-teal btn white black-text secondary-content">Send</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Custom Colors</h4>
    ...
    .waves-effect.waves-brown .waves-ripple {
     ...
     of the button to still show through. */
      background-color: rgba(121, 85, 72, 0.65);
          ...
          <div class="divider"></div>
          <!--  Circle  -->
          <div id="circle" class="section">
            <h4 class="header">Circle</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>If you want waves to form to a non rectangular shape, there is an option for circular waves. Just add the <code class="language-markup">waves-circle</code> in addition to <code class="language-markup">waves-effect</code>
                </p>
              </div>
              <div class="col s12 m8 l9">
                <p class="header">HTML Markup</p>
                <pre><code class="language-markup">
  ...
  &lt;/a>
                ...
                <div class="collection waves-color-demo">
                  <div class="collection-item">Default<a href="#!" class="waves-effect waves-circle btn-floating secondary-content"><i class="mdi-content-add"></i></a>
                  </div>
                  <div class="collection-item"><code class="language-markup">waves-light</code><a href="#!" class="waves-effect waves-circle waves-light btn-floating secondary-content"><i class="mdi-content-add"></i></a>
                  </div>
                </div>
              </div>
            </div>
