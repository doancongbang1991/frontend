  ...
  <div id="main">
    ...
    <div class="wrapper">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-chart"></i> Charts</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="charts-chartist.html">Chartist</a>
                                </li>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            <p class="caption"><a href="http://gionkunz.github.io/chartist-js/index.html" target="_blank">Chartist</a> - Simple Responsive Charts.</p>
