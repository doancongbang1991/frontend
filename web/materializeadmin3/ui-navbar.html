...
<head>
  ...
  <title>Navbar | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-navbar.html">Navbar</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Navbar</h5>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">The navbar is fully contained by an HTML5 Nav tag. Inside a recommended container div, there are 2 main parts of the navbar. A logo or brand link, and the navigations links. You can align these links to the left or right.</p>
          ...
          <div id="right-aligned-links" class="section">
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p>To right align your navbar links, just add a <code class=" language-markup">right</code> class to your <code class=" language-markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ul</span><span class="token punctuation">&gt;</span></span></code>                  that contains them.</p>
              </div>
          ...
          <div class="divider"></div>
          <!--Left Aligned Links-->
          <div id="left-aligned-links" class="section">
            <h4 class="header">Left Aligned Links</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>To left align your navbar links, just add a <code class=" language-markup">left</code> class to your <code class=" language-markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ul</span><span class="token punctuation">&gt;</span></span></code>                  that contains them.</p>
              </div>
              <div class="col s12 m8 l9">
                <nav class="indigo">
                  <div class="nav-wrapper">
          ...
          <div class="divider"></div>
          <!--Centering the logo-->
          <div id="centering-the-logo" class="section">
            <h4 class="header">Centering the logo</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>The logo will center itself on medium and down screens, but if you want the logo to always be centered, add the <code class=" language-markup">center</code> class to your <code class=" language-markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>brand-logo<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span></code>.
                  You will have to make sure yourself that links do not overlap if you use this.</p>
              </div>
              <div class="col s12 m8 l9">
                <nav class="purple">
          ...
          <div id="fixed-navbar">
            ...
            <h4 class="header">Fixed Navbar</h4>
            <p>To make the navbar fixed, you have to add an outer wrapping div with the class <code class=" language-markup">navbar-fixed</code>. This will offset your other content while making your nav fixed. You can adjust the height of this outer div
              to change how much offset is on your content.</p>
            <p>DEMO: You can see the theme top nav is fixed.</p>
          </div>

          <div class="divider"></div>
          <!--Navbar Dropdown Menu-->
          <div id="navbar-dropdown-menu" class="section">
            <h4 class="header">Navbar Dropdown Menu</h4>
            <div class="row">
              <div class="col s12 m4 l3">
                <p>To add a navbar dropdown menu, add the <code class=" language-markup">ul</code> dropdown structure into the page.Then, add an element to trigger the dropdown menu. Make sure to supply the id of the dropdown structure to the
                  <code class=" language-markup">data-activates</code> attribute of the dropdown trigger.</p>
              </div>
              <div class="col s12 m8 l9">
                <!-- Dropdown Structure -->
                ...
                <nav class="teal">
                  <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                      ...
                      <!-- Dropdown Trigger -->
                      <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Dropdown<i class="mdi-navigation-arrow-drop-down right"></i></a>
                      </li>
                    </ul>
                    </div>
                  </div>
          ...
          <div class="divider"></div>
          <!--Icon Links-->
          <div id="icon-links" class="section">
            <h4 class="header">Icon Links</h4>
            <div class="row">
              <div class="col s12 m4 l3">
              ...
              <div class="col s12 m8 l9">
                <nav class="green">
                  <div class="nav-wrapper">
                    ...
                    <a href="#!" class="brand-logo">Logo</a>
                    <ul class="right hide-on-med-and-down">
                      <li><a href="sass.html"><i class="mdi-action-search left"></i>Link with Left Icon</a>
                      </li>
                      <li><a href="components.html"><i class="mdi-action-view-module right"></i>Link with Right Icon</a>
                      </li>
                    </ul>
                    </div>
                  </div>
          ...
          <div id="mobile-collapse-button" class="section">
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p>When your nav bar is resized, you will see that the links on the right turn into a hamburger icon <i class="mdi-navigation-menu"></i>. Take a look at the example below to get this functionality. Add the entire <code class=" language-markup">button-collapse</code>                  line to your <code class=" language-markup">nav</code>.</p>
              </div>
              <div class="col s12 m8 l9">
