...
<head>
  ...
  <title>Pagination | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-pagination.html">Pagination</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Pagination</h5>
          ...
          <div id="pagination" class="section">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">BASIC PAGINATION</h4>
              </div>
              <div class="col s12 m8 l9">
                <ul class="pagination">
                  ...
                  <li class="waves-effect"><a href="#!"><i class="mdi-navigation-chevron-right"></i></a>
                  </li>
                </ul>
                <br>
                <br>
