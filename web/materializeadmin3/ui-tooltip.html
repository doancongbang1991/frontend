...
<head>
  ...
  <title>Tooltips | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-tooltip.html">Tooltip</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Tooltips</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">UI Elements</a>
                  </li>
                  <li class="active">Tooltips</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Tooltips are small, interactive, textual hints for mainly graphical elements. When using icons for actions you can use a tooltip to give people clarification on its function.</p>
          <div class="divider"></div>

          <!--toasts-->
          <div id="toasts" class="section">
            <h4 class="header">Tooltips</h4>
            <div class="row">
              ...
              <div class="col s12 m8 l9">
                <div class="row">
                  <a class="btn tooltipped col s4 l2 " data-position="bottom" data-delay="50" data-tooltip="I am tooltip"> Bottom</a>
            ...
            <div class="row">
              ...
              <div class="col s12 m8 l9">
                  <p>Add the Tooltipped class to your element and add either <a class="tooltipped" data-position="top" data-delay="50" data-tooltip="I am top tooltip">top</a>, <a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="I am bottom tooltip">bottom</a>, <a class="tooltipped" data-position="left" data-delay="50" data-tooltip="I am left tooltip">left</a>, <a class="tooltipped" data-position="right" data-delay="50" data-tooltip="I am right tooltip">right</a> on data-tooltip to control the position.</p>
              </div>
            </div>
