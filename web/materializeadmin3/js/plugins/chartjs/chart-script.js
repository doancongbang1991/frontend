...
var data = {
    labels: ["Đức Thắng", "Ricons", "FDC", "Megatech", "Minh Dương", "Hữu Danh", "BCH Diamond"],
    datasets: [{
            label: "First dataset",
...
*/
var radarChartData = {
    labels: ["Nam Hội An", "Landmark 81", "Diamond", "Masteri", "Vista Verde"],
    datasets: [{
        label: "First dataset",
...
*/
var lineChartData = {
    labels: ["TechOne", "FDC T1", "AA Corp", "Hà Linh", "TCons", "Ban An Ninh"],
    datasets: [{
        label: "My dataset",
