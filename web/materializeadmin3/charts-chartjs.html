  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-chart"></i> Charts</a>
                        <div class="collapsible-body">
                            <ul>
                                <li class="active"><a href="charts-chartjs.html">Chart JS</a>
                                </li>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            <p class="caption"><a href="http://www.chartjs.org/docs/#getting-started" target="_blank">Chart.js</a> provides simple, responsive, clean and engaging charts for designers and developers.</p>
