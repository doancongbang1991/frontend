                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-social-pages"></i> Pages</a>
                        <div class="collapsible-body">
                            <ul>                                        
                                ...
                                <li class="active"><a href="page-todo.html">ToDos</a>
                                </li>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Premium todo page to manage your personal task easily, Swipe right to remove it on touch screen.</p>
