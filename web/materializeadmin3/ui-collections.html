...
<head>
  ...
  <title>Collections | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="ui-collections.html">Collections</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Collections</h5>
        ...
        <div class="container">
          ...
          <div id="basic-collections" class="section">
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="header">Secondary content</p>
              </div>
              <div class="col s12 m8 l9">
                ...
                <ul class="collection with-header">
                  ...
                  <li class="collection-item">
                    <div>Alvin<a href="#!" class="secondary-content"><i class="mdi-content-send"></i></a>
                    </div>
                  </li>
                  <li class="collection-item">
                    <div>Alvin<a href="#!" class="secondary-content"><i class="mdi-content-send"></i></a>
            ...
            <div class="row">
              <div class="col s12 m4 l3">
                <p class="header">Avatar Content</p>
              </div>
              <div class="col s12 m8 l9">
          ...
          <!--Dismissable Content    -->
          <div class="divider"></div>
          <div id="dismissable-content" class="section">
            <h4 class="header">Dismissable Content</h4>
            <div class="row">
              <div class="col s12 m4 l3">
