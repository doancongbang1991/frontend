...
<head>
  ...
  <title>editableTable | Materialize - Material Design Admin Template</title>
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-editor-border-all"></i> Tables</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="table-editable.html">Editable Table</a>
                                </li>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">ediTable</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Dashboard</a>
                  </li>
                  <li><a href="#">Table</a>
                  </li>
                  <li class="active">editableTable</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><a href="http://ionden.com/a/plugins/ion.rangeSlider/en.html" target="_blank">editableTable</a> turns any table into an editable spreadsheet.</p>
          <div class="divider"></div>
          <!--editableTable-->
          <div id="editableTable" class="section">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">editableTable</h4>
              </div>
